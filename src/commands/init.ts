...
export async function runInit({ repoRoot }: InitOptions): Promise<void> {
  ...
  for (const skill of skillDirs) {
    ...
    await installSkill(src, repoRoot, skill);
    skillCount++;
  }

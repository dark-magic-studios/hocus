...
<div class="wrap">
  ...
  <section class="block">
    ...
    <div class="filetree">
      ...
      <div class="filetree-row"><span class="filetree-connector">├──</span><span class="filetree-name">.agents/plugins/</span><span class="filetree-desc">plugin bundle for Claude Code, Cursor and Antigravity (skills, agents, MCPs)</span></div>
